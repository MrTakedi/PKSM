...
export default function Home() {
  ...
  useEffect(() => {
    ...
    void loadCatalogs().then(() => setCatalogsReady(true)).catch(() => setCatalogsReady(false)).finally(() => setCatalogsLoading(false));
  }, [catalogsReady, editingId, saveFile, showPokedex]);
