...
import { catalogEntryForName, catalogForGeneration, generationCatalogs, type GameDefinition } from "@/lib/gameData";
...
export default function Home() {
  ...
  const selectedItemEntry = catalogEntryForName(activeCatalog.items, selected?.heldItem);
  const draftItemEntry = catalogEntryForName(activeCatalog.items, draft?.heldItem);
